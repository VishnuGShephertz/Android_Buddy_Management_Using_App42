...
import com.shephertz.app42.buddy.adapter.CheckListAdapter;
import com.shephertz.app42.buddy.adapter.ListAdapter;
import com.shephertz.app42.buddy.adapter.ListSeparationAdapter;
...
public class GroupActivity extends Activity implements OnItemClickListener,
	...
	private ListSeparationAdapter adapter;
	...
	public void makeList() {
		adapter = new ListSeparationAdapter(this);
		if (groupFriends.size() > 0) {
			ListAdapter mylist = new ListAdapter(this, groupFriends);
			adapter.addSection("Group Friedns", mylist);
		}
		if (nonGroupFriedns.size() > 0) {
			CheckListAdapter mylist1 = new CheckListAdapter(this,
					nonGroupFriedns);
